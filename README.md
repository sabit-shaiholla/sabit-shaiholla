...
Code here, reasoning on [my site](https://sabit-shaikholla.github.io/portfolio/).
...
### [Agentic File Query](https://github.com/sabit-shaikholla/agentic-file-query) · [write-up](https://sabit-shaikholla.github.io/portfolio/agentic-file-query/)
...
### [Corrective RAG + OpenEvals](https://github.com/sabit-shaikholla/corrective-rag-openevals) · [write-up](https://sabit-shaikholla.github.io/portfolio/corrective-rag-openevals/)
...
### [Gemini File Search Tool](https://github.com/sabit-shaikholla/gemini-api-file-search-tool) · [live demo](https://filequerysystem.duckdns.org/) · [write-up](https://sabit-shaikholla.github.io/portfolio/gemini-api-file-search-tool/)

Managed RAG end to end: upload a PDF, get answers with grounding metadata pointing at source chunks. Runs on an Oracle Cloud always-free instance behind Nginx + Let's Encrypt, with CI pushing releases. Setup documented [step by step](https://sabit-shaikholla.github.io/portfolio/oracle-cloud-setup-gemini-tool/).
...
|---|---|---|
| [iot-edge-latency](https://github.com/sabit-shaikholla/iot-edge-latency) | Measures latency and QoS trade-offs across Raspberry Pi, EC2, local VM, and AWS Greengrass nodes using Aruco-marker video as ground truth | Python, OpenCV, AWS Greengrass, MQTT |
| [ecommerce-microservices](https://github.com/sabit-shaikholla/ecommerce-microservices) | Event-driven e-commerce platform: service discovery, distributed tracing, Keycloak auth | Spring Boot, Kafka, Eureka, Zipkin, Keycloak |
| [football-oracle](https://github.com/sabit-shaikholla/football-oracle) | AI-driven player analytics with JWT auth, generated reports, and SonarQube in CI | Spring Boot, React, PostgreSQL, Vertex AI |
| [ai-llm-tutorials](https://github.com/sabit-shaikholla/ai-llm-tutorials) | Hands-on notebooks working through LLM mechanics and RAG patterns | Python, Jupyter |
...
- **[Beyond RAG: Building an AI Agent That Explores Documents Like a Human Researcher](https://sabit-shaikholla.github.io/portfolio/agentic-file-query/)** <sub>Feb 2026</sub>
- **[How I Setup Oracle Cloud Always Free Instance for Gemini API File Search Tool](https://sabit-shaikholla.github.io/portfolio/oracle-cloud-setup-gemini-tool/)** <sub>Nov 2025</sub>
- **[Revolutionizing RAG: Why Gemini File Search Tool is the great RAG-as-a-Service](https://sabit-shaikholla.github.io/portfolio/gemini-api-file-search-tool/)** <sub>Nov 2025</sub>
- **[Enhancing LLM Agent Reliability with Corrective RAG and OpenEvals](https://sabit-shaikholla.github.io/portfolio/corrective-rag-openevals/)** <sub>May 2025</sub>
<!-- BLOG-POST-LIST:END -->

→ [All posts](https://sabit-shaikholla.github.io/portfolio/) · [TIL notes](https://sabit-shaikholla.github.io/til/) · [RSS](https://sabit-shaikholla.github.io/index.xml)
